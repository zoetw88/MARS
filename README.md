...
- Salary and Working hour Comparative Report
  ...
  -  Implemented recommendation system by applying **Frequent Pattern Growth Algorithm** based on other users search history 
     to find the most frequent and relevant company to users 
