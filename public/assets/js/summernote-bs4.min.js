...
'object'==typeof exports&&'undefined'!=typeof module?e(require('jquery')):'function'==typeof define&&define.amd?define(['jquery'], e):e((t=t||self).jQuery);
  ...
  'use strict'; C=C&&C.hasOwnProperty('default')?C.default:C; const i=function() {
  ...
  }; const t=o('<div class="note-editor note-frame card"/>'); const e=o('<div class="note-toolbar card-header" role="toolbar"></div>'); const n=o('<div class="note-editing-area"/>'); const r=o('<textarea class="note-codable" role="textbox" aria-multiline="true"/>'); const s=o('<div class="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>'); const a=o(['<output class="note-status-output" aria-live="polite"/>', '<div class="note-statusbar" role="status">', '  <output class="note-status-output" aria-live="polite"></output>', '  <div class="note-resizebar" role="seperator" aria-orientation="horizontal" aria-label="Resize">', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '  </div>', '</div>'].join('')); const l=o('<div class="note-editor"/>'); const c=o(['<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>', '<output class="note-status-output" aria-live="polite"/>'].join('')); const d=o('<div class="note-btn-group btn-group">'); const u=o('<div class="dropdown-menu" role="list">', function(t, i) {
    const e=Array.isArray(i.items)?i.items.map(function(t) {
      const e='string'==typeof t?t:t.value||''; const o=i.template?i.template(t):t; const n='object'==typeof t?t.option:void 0; return '<a class="dropdown-item" href="#" '+('data-value="'+e+'"'+(void 0!==n?' data-option="'+n+'"':''))+' role="listitem" aria-label="'+e+'">'+o+'</a>';
    }).join(''):i.items; t.html(e).attr({'aria-label': i.title});
  }); const h=o('<div class="dropdown-menu note-check" role="list">', function(t, n) {
    const e=Array.isArray(n.items)?n.items.map(function(t) {
      const e='string'==typeof t?t:t.value||''; const o=n.template?n.template(t):t; return '<a class="dropdown-item" href="#" data-value="'+e+'" role="listitem" aria-label="'+t+'">'+v(n.checkClassName)+' '+o+'</a>';
  ...
  }); const g=o('<div class="form-check"></div>', function(t, e) {
  ...
  }; var b={editor: t, toolbar: e, editingArea: n, codable: r, editable: s, statusbar: a, airEditor: l, airEditable: c, buttonGroup: d, dropdown: u, dropdownButtonContents: function(t) {
    return t;
  ...
  } const W=O('PRE'); const q=O('LI'); const V=O('TABLE'); const G=O('DATA'); function _(t) {
    ...
    return _(t)&&!!st(t, K);
  }, isPre: W, isList: Z, isTable: V, isData: G, isCell: Q, isBlockquote: J, isBodyContainer: X, isAnchor: tt, isDiv: O('DIV'), isLi: q, isBR: O('BR'), isSpan: O('SPAN'), isB: O('B'), isU: O('U'), isS: O('S'), isI: O('I'), isImg: O('IMG'), isTextarea: It, isEmpty: it, isEmptyAnchor: A.and(tt, it), isClosestSibling: function(t, e) {
...
this.options.disableDragAndDrop?(this.documentEventHandlers.onDrop=function(t) {
  ...
  }(); R.hasCodeMirror&&(Ot=window.CodeMirror); const qt=function() {
    function t(t) {
