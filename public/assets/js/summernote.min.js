...
'object'==typeof exports&&'undefined'!=typeof module?e(require('jquery')):'function'==typeof define&&define.amd?define(['jquery'], e):e((t=t||self).jQuery);
  ...
  'use strict'; C=C&&C.hasOwnProperty('default')?C.default:C; const i=function() {
    function t(t, e, o, n) {
      this.markup=t, this.children=e, this.options=o, this.callback=n;
    } return t.prototype.render=function(t) {
      const o=C(this.markup); if (this.options&&this.options.contents&&o.html(this.options.contents), this.options&&this.options.className&&o.addClass(this.options.className), this.options&&this.options.data&&C.each(this.options.data, function(t, e) {
        o.attr('data-'+t, e);
      }), this.options&&this.options.click&&o.on('click', this.options.click), this.children) {
        const e=o.find('.note-children-container'); this.children.forEach(function(t) {
    ...
    return function() {
      const t='object'==typeof arguments[1]?arguments[1]:arguments[0]; let e=Array.isArray(arguments[0])?arguments[0]:[]; return t&&t.children&&(e=t.children), new i(o, e, t, n);
    };
  }; const t=o('<div class="note-editor note-frame panel panel-default"/>'); const e=o('<div class="note-toolbar panel-heading" role="toolbar"></div></div>'); const n=o('<div class="note-editing-area"/>'); const r=o('<textarea class="note-codable" role="textbox" aria-multiline="true"/>'); const s=o('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>'); const a=o(['<output class="note-status-output" aria-live="polite"/>', '<div class="note-statusbar" role="status">', '  <div class="note-resizebar" role="seperator" aria-orientation="horizontal" aria-label="Resize">', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '  </div>', '</div>'].join('')); const l=o('<div class="note-editor"/>'); const c=o(['<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>', '<output class="note-status-output" aria-live="polite"/>'].join('')); const d=o('<div class="note-btn-group btn-group">'); const u=o('<ul class="dropdown-menu" role="list">', function(t, i) {
    const e=Array.isArray(i.items)?i.items.map(function(t) {
      const e='string'==typeof t?t:t.value||''; const o=i.template?i.template(t):t; const n='object'==typeof t?t.option:void 0; return '<li role="listitem" aria-label="'+e+'"><a href="#" '+('data-value="'+e+'"'+(void 0!==n?' data-option="'+n+'"':''))+'>'+o+'</a></li>';
    }).join(''):i.items; t.html(e).attr({'aria-label': i.title});
  }); const h=o('<ul class="dropdown-menu note-check" role="list">', function(t, n) {
    const e=Array.isArray(n.items)?n.items.map(function(t) {
      const e='string'==typeof t?t:t.value||''; const o=n.template?n.template(t):t; return '<li role="listitem" aria-label="'+t+'"><a href="#" data-value="'+e+'">'+v(n.checkClassName)+' '+o+'</a></li>';
    }).join(''):n.items; t.html(e).attr({'aria-label': n.title});
  }); const p=o('<div class="note-color-palette"/>', function(t, e) {
  ...
  }); const f=o('<div class="modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function(t, e) {
  ...
  }); const m=o(['<div class="note-popover popover in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', '</div>'].join(''), function(t, e) {
    const o=void 0!==e.direction?e.direction:'bottom'; t.addClass(o), e.hideArrow&&t.find('.arrow').hide();
  }); const g=o('<div class="checkbox"></div>', function(t, e) {
  ...
  }; var b={editor: t, toolbar: e, editingArea: n, codable: r, editable: s, statusbar: a, airEditor: l, airEditable: c, buttonGroup: d, dropdown: u, dropdownButtonContents: function(t, e) {
    return t+' '+v(e.icons.caret, 'span');
  }, dropdownCheck: h, palette: p, dialog: f, popover: m, checkbox: g, icon: v, options: {}, button: function(t, e) {
  ...
  }, isW3CRangeSupport: !!document.createRange, inputEventName: E}; let L=0; const A={eq: function(e) {
    return function(t) {
      return e===t;
    };
  }, eq2: function(t, e) {
    ...
    let s; return function() {
      const t=this; const e=arguments; const o=r&&!s; clearTimeout(s), s=setTimeout(function() {
  ...
  } const B={head: F, last: P, initial: function(t) {
    ...
    return t.length?H(t).reduce(function(t, e) {
      const o=P(t); return n(P(o), e)?o[o.length]=e:t[t.length]=[e], t;
    }, [[F(t)]]):[];
  }, compact: function(t) {
    for (var e=[], o=0, n=t.length; o<n; o++)t[o]&&e.push(t[o]); return e;
  }, unique: function(t) {
    for (var e=[], o=0, n=t.length; o<n; o++)D(e, t[o])||e.push(t[o]); return e;
  }}; const z=String.fromCharCode(160); function M(t) {
  ...
  } const W=O('PRE'); const V=O('LI'); const q=O('TABLE'); const G=O('DATA'); function _(t) {
    ...
    return Q(t)||J(t)||M(t);
  } const tt=O('A'); const et=O('BODY'); const ot=R.isMSIE&&R.browserVersion<11?'&nbsp;':'<br>'; function nt(t) {
    return U(t)?t.nodeValue.length:t?t.childNodes.length:0;
  } function it(t) {
    const e=nt(t); return 0===e||(!U(t)&&1===e&&t.innerHTML===ot||!(!B.all(t.childNodes, U)||''!==t.innerHTML));
  } function rt(t) {
    ...
    e=e||A.fail; const o=[]; return st(t, function(t) {
      return M(t)||o.push(t), e(t);
    }), o;
  } function lt(t, e) {
    e=e||A.fail; for (var o=[]; t&&!e(t);)o.push(t), t=t.nextSibling; return o;
  } function ct(t, e) {
    ...
    let o; let n; if (nt(t.node)===t.offset) {
    ...
    let o=e&&e.isSkipPaddingBlankHTML; const n=e&&e.isNotSplitEdgePoint; const i=e&&e.isDiscardEmptySplits; if (i&&(o=!0), pt(t)&&(U(t.node)||n)) {
      if (ut(t)) return t.node; if (ht(t)) return t.node.nextSibling;
    } if (U(t.node)) return t.node.splitText(t.offset); const r=t.node.childNodes[t.offset]; const s=ct(t.node.cloneNode(!1), t.node); return dt(s, lt(r)), o||(rt(t.node), rt(s)), i&&(it(t.node)&&St(t.node), it(s))?(St(s), t.node.nextSibling):s;
  } function wt(t, o, n) {
    const e=at(o.node, A.eq(t)); return e.length?1===e.length?Ct(o, n):e.reduce(function(t, e) {
  ...
  } const It=O('TEXTAREA'); function Tt(t, e) {
    const o=It(t[0])?t.val():t.html(); return e?o.replace(/[\n\r]/g, ''):o;
  } const $t={NBSP_CHAR: z, ZERO_WIDTH_NBSP_CHAR: '\ufeff', blank: ot, emptyPara: '<p>'+ot+'</p>', makePredByNodeName: O, isEditable: M, isControlSizing: function(t) {
    return t&&C(t).hasClass('note-control-sizing');
  }, isText: U, isElement: function(t) {
    return t&&1===t.nodeType;
  }, isVoid: j, isPara: K, isPurePara: function(t) {
    return K(t)&&!V(t);
  }, isHeading: function(t) {
    return t&&/^H[1-7]/.test(t.nodeName.toUpperCase());
  }, isInline: _, isBlock: A.not(_), isBodyInline: function(t) {
    return _(t)&&!st(t, K);
  }, isBody: et, isParaInline: function(t) {
    return _(t)&&!!st(t, K);
  }, isPre: W, isList: Z, isTable: q, isData: G, isCell: Q, isBlockquote: J, isBodyContainer: X, isAnchor: tt, isDiv: O('DIV'), isLi: V, isBR: O('BR'), isSpan: O('SPAN'), isB: O('B'), isU: O('U'), isS: O('S'), isI: O('I'), isImg: O('IMG'), isTextarea: It, isEmpty: it, isEmptyAnchor: A.and(tt, it), isClosestSibling: function(t, e) {
    return t.nextSibling===e||t.previousSibling===e;
  }, withClosestSiblings: function(t, e) {
    e=e||A.ok; const o=[]; return t.previousSibling&&e(t.previousSibling)&&o.push(t.previousSibling), o.push(t), t.nextSibling&&e(t.nextSibling)&&o.push(t.nextSibling), o;
  }, nodeLength: nt, isLeftEdgePoint: ut, isRightEdgePoint: ht, isEdgePoint: pt, isLeftEdgeOf: ft, isRightEdgeOf: mt, isLeftEdgePointOf: function(t, e) {
    return ut(t)&&ft(t.node, e);
  }, isRightEdgePointOf: function(t, e) {
    return ht(t)&&mt(t.node, e);
  }, prevPoint: bt, nextPoint: yt, isSamePoint: kt, isVisiblePoint: function(t) {
    if (U(t.node)||!vt(t.node)||it(t.node)) return !0; const e=t.node.childNodes[t.offset-1]; const o=t.node.childNodes[t.offset]; return !(e&&!j(e)||o&&!j(o));
    ...
    if (!U(t.node)) return !1; const e=t.node.nodeValue.charAt(t.offset-1); return e&&' '!==e&&e!==z;
  }, walkPoint: function(t, e, o, n) {
    for (let i=t; i&&(o(i), !kt(i, e));)i=yt(i, n&&t.node!==i.node&&e.node!==i.node);
  }, ancestor: st, singleChildAncestor: function(t, e) {
    for (t=t.parentNode; t&&1===nt(t);) {
      if (e(t)) return t; if (M(t)) break; t=t.parentNode;
    } return null;
  }, listAncestor: at, lastAncestor: function(t, e) {
    const o=at(t); return B.last(o.filter(e));
  }, listNext: lt, listPrev: function(t, e) {
    e=e||A.fail; for (var o=[]; t&&!e(t);)o.push(t), t=t.previousSibling; return o;
  }, listDescendant: function(i, r) {
    const s=[]; return r=r||A.ok, function t(e) {
      i!==e&&r(e)&&s.push(e); for (let o=0, n=e.childNodes.length; o<n; o++)t(e.childNodes[o]);
    }(i), s;
  }, commonAncestor: function(t, e) {
    for (let o=at(t), n=e; n; n=n.parentNode) if (-1<o.indexOf(n)) return n; return null;
  }, wrap: function(t, e) {
    const o=t.parentNode; const n=C('<'+e+'>')[0]; return o.insertBefore(n, t), n.appendChild(t), n;
  }, insertAfter: ct, appendChildNodes: dt, position: gt, hasChildren: vt, makeOffsetPath: function(t, e) {
  ...
  }, splitTree: wt, splitPoint: function(t, e) {
    let o; let n; const i=e?K:X; const r=at(t.node, i); const s=B.last(r)||t.node; n=i(s)?(o=r[r.length-2], s):(o=s).parentNode; let a=o&&wt(o, t, {isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e}); return a||n!==t.node||(a=t.node.childNodes[t.offset]), {rightNode: a, container: n};
  }, create: xt, createText: function(t) {
    return document.createTextNode(t);
  }, remove: St, removeWhile: function(t, e) {
    for (;t&&!M(t)&&e(t);) {
      const o=t.parentNode; St(t), t=o;
    }
  }, replace: function(t, e) {
    if (t.nodeName.toUpperCase()===e.toUpperCase()) return t; const o=xt(e); return t.style.cssText&&(o.style.cssText=t.style.cssText), dt(o, B.from(t.childNodes)), ct(o, t), St(t), o;
  }, html: function(t, e) {
    let o=Tt(t); e&&(o=(o=o.replace(/<(\/?)(\b(?!!)[^>\s]*)(.*?)(\s*\/?>)/g, function(t, e, o) {
      o=o.toUpperCase(); const n=/^DIV|^TD|^TH|^P|^LI|^H[1-7]/.test(o)&&!!e; const i=/^BLOCKQUOTE|^TABLE|^TBODY|^TR|^HR|^UL|^OL/.test(o); return t+(n||i?'\n':'');
    })).trim()); return o;
  }, value: Tt, posFromPlaceholder: function(t) {
    const e=C(t); const o=e.offset(); const n=e.outerHeight(!0); return {left: o.left, top: o.top+n};
    ...
    function t(t, e) {
      ...
      const t=this.isDisabled(); this.code($t.emptyPara), this._destroy(), this._initialize(), t&&this.disable();
    }, t.prototype._initialize=function() {
      const e=this; const o=C.extend({}, this.options.buttons); Object.keys(o).forEach(function(t) {
        e.memo('button.'+t, o[t]);
      }); const n=C.extend({}, this.options.modules, C.summernote.plugins||{}); Object.keys(n).forEach(function(t) {
        e.module(t, n[t], !0);
      }), Object.keys(this.modules).forEach(function(t) {
        e.initializeModule(t);
      });
    }, t.prototype._destroy=function() {
      const e=this; Object.keys(this.modules).reverse().forEach(function(t) {
        e.removeModule(t);
      ...
      const t=B.head(arguments); const e=B.tail(B.from(arguments)); const o=this.options.callbacks[A.namespaceToCamel(t, 'on')]; o&&o.apply(this.$note[0], e), this.$note.trigger('summernote.'+t, e);
    }, t.prototype.initializeModule=function(t) {
      const e=this.modules[t]; e.shouldInitialize=e.shouldInitialize||A.ok, e.shouldInitialize()&&(e.initialize&&e.initialize(), e.events&&$t.attachEvents(this.$note, e.events));
      ...
      const e=this.modules[t]; e.shouldInitialize()&&(e.events&&$t.detachEvents(this.$note, e.events), e.destroy&&e.destroy()), delete this.modules[t];
      ...
      const n=this; return function(t) {
        n.createInvokeHandler(e, o)(t), n.invoke('buttons.updateCurrentStyle');
      };
    }, t.prototype.createInvokeHandler=function(o, n) {
      const i=this; return function(t) {
        t.preventDefault(); const e=C(t.target); i.invoke(o, n||e.closest('[data-value]').data('value'), e);
      };
    }, t.prototype.invoke=function() {
      const t=B.head(arguments); const e=B.tail(B.from(arguments)); const o=t.split('.'); const n=1<o.length; const i=n&&B.head(o); const r=n?B.last(o):B.head(o); const s=this.modules[i||'editor']; return !i&&this[r]?this[r].apply(this, e):s&&s[r]&&s.shouldInitialize()?s[r].apply(s, e):void 0;
    }, t;
  }(); function Et(t, e) {
    let o; let n; let i=t.parentElement(); const r=document.body.createTextRange(); const s=B.from(i.childNodes); for (o=0; o<s.length; o++) {
      if (!$t.isText(s[o])) {
        if (r.moveToElementText(s[o]), 0<=r.compareEndPoints('StartToStart', t)) break; n=s[o];
      }
    } if (0!==o&&$t.isText(s[o-1])) {
      const a=document.body.createTextRange(); let l=null; a.moveToElementText(n||i), a.collapse(!n), l=n?n.nextSibling:i.firstChild; const c=t.duplicate(); c.setEndPoint('StartToStart', a); for (var d=c.text.replace(/[\r\n]/g, '').length; d>l.nodeValue.length&&l.nextSibling;)d-=l.nodeValue.length, l=l.nextSibling; l.nodeValue; e&&l.nextSibling&&$t.isText(l.nextSibling)&&d===l.nodeValue.length&&(d-=l.nodeValue.length, l=l.nextSibling), i=l, o=d;
    } return {cont: i, offset: o};
  } function Rt(t) {
    var s=function(t, e) {
      let o; let n; if ($t.isText(t)) {
        const i=$t.listPrev(t, A.not($t.isText)); const r=B.last(i).previousSibling; o=r||t.parentNode, e+=B.sum(B.tail(i), $t.nodeLength), n=!r;
      } else {
        if (o=t.childNodes[e]||t, $t.isText(o)) return s(o, 0); e=0, n=!1;
      } return {node: o, collapseToStart: n, offset: e};
    }; const e=document.body.createTextRange(); const o=s(t.node, t.offset); return e.moveToElementText(o.node), e.collapse(o.collapseToStart), e.moveStart('character', o.offset), e;
  }C.fn.extend({summernote: function() {
    const t=C.type(B.head(arguments)); const e='string'===t; const o='object'===t; const i=C.extend({}, C.summernote.options, o?B.head(arguments):{}); i.langInfo=C.extend(!0, {}, C.summernote.lang['en-US'], C.summernote.lang[i.lang]), i.icons=C.extend(!0, {}, C.summernote.options.icons, i.icons), i.tooltip='auto'===i.tooltip?!R.isSupportTouch:i.tooltip, this.each(function(t, e) {
      const o=C(e); if (!o.data('summernote')) {
        const n=new Nt(o, i); o.data('summernote', n), o.data('summernote').triggerEvent('init', n.layoutInfo);
      }
    }); const n=this.first(); if (n.length) {
      const r=n.data('summernote'); if (e) return r.invoke.apply(r, B.from(arguments)); i.focus&&r.invoke('editor.focus');
    } return this;
  }}); const Lt=function() {
    function r(t, e, o, n) {
      ...
      } const e=Rt({node: this.sc, offset: this.so}); return e.setEndPoint('EndToEnd', Rt({node: this.ec, offset: this.eo})), e;
      ...
      const t=this.nativeRange(); if (R.isW3CRangeSupport) {
      ...
      const e=C(t).height(); return t.scrollTop+e<this.sc.offsetTop&&(t.scrollTop+=Math.abs(t.scrollTop+e-this.sc.offsetTop)), this;
    }, r.prototype.normalize=function() {
      const t=function(t, e) {
        if ($t.isVisiblePoint(t)&&(!$t.isEdgePoint(t)||$t.isRightEdgePoint(t)&&!e||$t.isLeftEdgePoint(t)&&e||$t.isRightEdgePoint(t)&&e&&$t.isVoid(t.node.nextSibling)||$t.isLeftEdgePoint(t)&&!e&&$t.isVoid(t.node.previousSibling)||$t.isBlock(t.node)&&$t.isEmpty(t.node))) return t; const o=$t.ancestor(t.node, $t.isBlock); if (($t.isLeftEdgePointOf(t, o)||$t.isVoid($t.prevPoint(t).node))&&!e||($t.isRightEdgePointOf(t, o)||$t.isVoid($t.nextPoint(t).node))&&e) {
          if ($t.isVisiblePoint(t)) return t; e=!e;
        } return (e?$t.nextPointUntil($t.nextPoint(t), $t.isVisiblePoint):$t.prevPointUntil($t.prevPoint(t), $t.isVisiblePoint))||t;
      }; const e=t(this.getEndPoint(), !1); const o=this.isCollapsed()?e:t(this.getStartPoint(), !0); return new r(o.node, o.offset, e.node, e.offset);
    }, r.prototype.nodes=function(o, t) {
      o=o||A.ok; const n=t&&t.includeAncestor; const i=t&&t.fullyContains; const e=this.getStartPoint(); const r=this.getEndPoint(); const s=[]; const a=[]; return $t.walkPoint(e, r, function(t) {
        let e; $t.isEditable(t.node)||(i?($t.isLeftEdgePoint(t)&&a.push(t.node), $t.isRightEdgePoint(t)&&B.contains(a, t.node)&&(e=t.node)):e=n?$t.ancestor(t.node, o):t.node, e&&o(e)&&s.push(e));
      }, !0), B.unique(s);
    }, r.prototype.commonAncestor=function() {
      return $t.commonAncestor(this.sc, this.ec);
    }, r.prototype.expand=function(t) {
      const e=$t.ancestor(this.sc, t); const o=$t.ancestor(this.ec, t); if (!e&&!o) return new r(this.sc, this.so, this.ec, this.eo); const n=this.getPoints(); return e&&(n.sc=e, n.so=0), o&&(n.ec=o, n.eo=$t.nodeLength(o)), new r(n.sc, n.so, n.ec, n.eo);
      ...
      const t=this.sc===this.ec; const e=this.getPoints(); return $t.isText(this.ec)&&!$t.isEdgePoint(this.getEndPoint())&&this.ec.splitText(this.eo), $t.isText(this.sc)&&!$t.isEdgePoint(this.getStartPoint())&&(e.sc=this.sc.splitText(this.so), e.so=0, t&&(e.ec=e.sc, e.eo=this.eo-this.so)), new r(e.sc, e.so, e.ec, e.eo);
    }, r.prototype.deleteContents=function() {
      if (this.isCollapsed()) return this; const t=this.splitText(); const e=t.nodes(null, {fullyContains: !0}); const n=$t.prevPointUntil(t.getStartPoint(), function(t) {
        return !B.contains(e, t.node);
      }); const i=[]; return C.each(e, function(t, e) {
        const o=e.parentNode; n.node!==o&&1===$t.nodeLength(o)&&i.push(o), $t.remove(e, !1);
      }), C.each(i, function(t, e) {
        $t.remove(e, !1);
      }), new r(n.node, n.offset, n.node, n.offset).normalize();
    }, r.prototype.makeIsOn=function(e) {
      return function() {
        const t=$t.ancestor(this.sc, e); return !!t&&t===$t.ancestor(this.ec, e);
      };
    }, r.prototype.isLeftEdgeOf=function(t) {
      if (!$t.isLeftEdgePoint(this.getStartPoint())) return !1; const e=$t.ancestor(this.sc, t); return e&&$t.isLeftEdgeOf(this.sc, e);
    }, r.prototype.isCollapsed=function() {
      return this.sc===this.ec&&this.so===this.eo;
    }, r.prototype.wrapBodyInlineWithPara=function() {
      if ($t.isBodyContainer(this.sc)&&$t.isEmpty(this.sc)) return this.sc.innerHTML=$t.emptyPara, new r(this.sc.firstChild, 0, this.sc.firstChild, 0); let t; const e=this.normalize(); if ($t.isParaInline(this.sc)||$t.isPara(this.sc)) return e; if ($t.isInline(e.sc)) {
        const o=$t.listAncestor(e.sc, A.not($t.isInline)); t=B.last(o), $t.isInline(t)||(t=o[o.length-2]||e.sc.childNodes[e.so]);
      } else t=e.sc.childNodes[0<e.so?e.so-1:0]; let n=$t.listPrev(t, $t.isParaInline).reverse(); if ((n=n.concat($t.listNext(t.nextSibling, $t.isParaInline))).length) {
        const i=$t.wrap(B.head(n), 'p'); $t.appendChildNodes(i, B.tail(n));
      } return this.normalize();
    }, r.prototype.insertNode=function(t) {
      const e=this.wrapBodyInlineWithPara().deleteContents(); const o=$t.splitPoint(e.getStartPoint(), $t.isInline(t)); return o.rightNode?o.rightNode.parentNode.insertBefore(t, o.rightNode):o.container.appendChild(t), t;
    }, r.prototype.pasteHTML=function(t) {
      const e=C('<div></div>').html(t)[0]; let o=B.from(e.childNodes); const n=this.wrapBodyInlineWithPara().deleteContents(); return 0<n.so&&(o=o.reverse()), o=o.map(function(t) {
        return n.insertNode(t);
      }), 0<n.so&&(o=o.reverse()), o;
    }, r.prototype.toString=function() {
      const t=this.nativeRange(); return R.isW3CRangeSupport?t.toString():t.text;
    }, r.prototype.getWordRange=function(t) {
      let e=this.getEndPoint(); if (!$t.isCharPoint(e)) return this; const o=$t.prevPointUntil(e, function(t) {
    ...
    if (4===arguments.length) return new Lt(t, e, o, n); if (2===arguments.length) return new Lt(o=t, n=e, o, n); let i=this.createFromSelection(); return i||1!==arguments.length?i:(i=this.createFromNode(t)).collapse($t.emptyPara===t.innerHTML);
  }, createFromSelection: function() {
    let t; let e; let o; let n; if (R.isW3CRangeSupport) {
      const i=document.getSelection(); if (!i||0===i.rangeCount) return null; if ($t.isBody(i.anchorNode)) return null; const r=i.getRangeAt(0); t=r.startContainer, e=r.startOffset, o=r.endContainer, n=r.endOffset;
    } else {
      const s=document.selection.createRange(); const a=s.duplicate(); a.collapse(!1); const l=s; l.collapse(!0); let c=Et(l, !0); const d=Et(a, !1); $t.isText(c.node)&&$t.isLeftEdgePoint(c)&&$t.isTextNode(d.node)&&$t.isRightEdgePoint(d)&&d.node.nextSibling===c.node&&(c=d), t=c.cont, e=c.offset, o=d.cont, n=d.offset;
    } return new Lt(t, e, o, n);
  }, createFromNode: function(t) {
    let e=t; let o=0; let n=t; let i=$t.nodeLength(n); return $t.isVoid(e)&&(o=$t.listPrev(e).length-1, e=e.parentNode), $t.isBR(n)?(i=$t.listPrev(n).length-1, n=n.parentNode):$t.isVoid(n)&&(i=$t.listPrev(n).length, n=n.parentNode), this.create(e, o, n, i);
    ...
    const o=$t.fromOffsetPath(t, e.s.path); const n=e.s.offset; const i=$t.fromOffsetPath(t, e.e.path); const r=e.e.offset; return new Lt(o, n, i, r);
  }, createFromParaBookmark: function(t, e) {
    const o=t.s.offset; const n=t.e.offset; const i=$t.fromOffsetPath(B.head(e), t.s.path); const r=$t.fromOffsetPath(B.last(e), t.e.path); return new Lt(i, o, r, n);
  ...
  }, nameFromCode: A.invertObject(Ft), code: Ft}; const Ht=function() {
    function t(t) {
    ...
    function t() {} return t.prototype.jQueryCSS=function(o, t) {
      if (R.jqueryVersion<1.9) {
        const n={}; return C.each(t, function(t, e) {
          n[e]=o.css(e);
        }), n;
      } return o.css(t);
      ...
      t=t.splitText(); const o=e&&e.nodeName||'SPAN'; const n=!(!e||!e.expandClosestSibling); const i=!(!e||!e.onlyPartialContains); if (t.isCollapsed()) return [t.insertNode($t.create(o))]; let r=$t.makePredByNodeName(o); const s=t.nodes($t.isText, {fullyContains: !0}).map(function(t) {
        return $t.singleChildAncestor(t, r)||$t.wrap(t, o);
      }); if (n) {
        if (i) {
          const a=t.nodes(); r=A.and(r, function(t) {
            return B.contains(a, t);
          });
        } return s.map(function(t) {
          const e=$t.withClosestSiblings(t, r); const o=B.head(e); const n=B.tail(e); return C.each(n, function(t, e) {
            $t.appendChildNodes(o, e.childNodes), $t.remove(e);
          }), B.head(e);
        });
      } return s;
    }, t.prototype.current=function(t) {
      const e=C($t.isElement(t.sc)?t.sc:t.sc.parentNode); let o=this.fromNode(e); try {
        ...
        const n=-1<['circle', 'disc', 'disc-leading-zero', 'square'].indexOf(o['list-style-type']); o['list-style']=n?'unordered':'ordered';
      } else o['list-style']='none'; const i=$t.ancestor(t.sc, $t.isPara); if (i&&i.style['line-height'])o['line-height']=i.style.lineHeight; else {
        const r=parseInt(o['line-height'], 10)/parseInt(o['font-size'], 10); o['line-height']=r.toFixed(1);
    ...
    function t() {} return t.prototype.insertOrderedList=function(t) {
      ...
      const i=this; const e=At.create(t).wrapBodyInlineWithPara(); const o=e.nodes($t.isPara, {includeAncestor: !0}); const n=B.clusterBy(o, A.peq2('parentNode')); C.each(n, function(t, e) {
        const o=B.head(e); if ($t.isLi(o)) {
          const n=i.findList(o.previousSibling); n?e.map(function(t) {
      ...
      const n=this; const e=At.create(t).wrapBodyInlineWithPara(); const o=e.nodes($t.isPara, {includeAncestor: !0}); const i=B.clusterBy(o, A.peq2('parentNode')); C.each(i, function(t, e) {
        const o=B.head(e); $t.isLi(o)?n.releaseList([e]):C.each(e, function(t, e) {
          C(e).css('marginLeft', function(t, e) {
      ...
      const n=this; const e=At.create(t).wrapBodyInlineWithPara(); let i=e.nodes($t.isPara, {includeAncestor: !0}); const r=e.paraBookmark(i); const s=B.clusterBy(i, A.peq2('parentNode')); if (B.find(i, $t.isPurePara)) {
        let a=[]; C.each(s, function(t, e) {
          a=a.concat(n.wrapList(e, o));
        }), i=a;
      } else {
        const l=e.nodes($t.isList, {includeAncestor: !0}).filter(function(t) {
      ...
      const o=B.head(t); const n=B.last(t); const i=$t.isList(o.previousSibling)&&o.previousSibling; const r=$t.isList(n.nextSibling)&&n.nextSibling; const s=i||$t.insertAfter($t.create(e||'UL'), n); return t=t.map(function(t) {
      ...
      const d=this; let u=[]; return C.each(t, function(t, e) {
        const o=B.head(e); const n=B.last(e); const i=c?$t.lastAncestor(o, $t.isList):o.parentNode; const r=i.parentNode; if ('LI'===i.parentNode.nodeName) {
          e.map(function(t) {
            const e=d.findNextSiblings(t); r.nextSibling?r.parentNode.insertBefore(t, r.nextSibling):r.parentNode.appendChild(t), e.length&&(d.wrapList(e, i.nodeName), t.appendChild(e[0].parentNode));
          }), 0===i.children.length&&r.removeChild(i), 0===r.childNodes.length&&r.parentNode.removeChild(r);
        } else {
          const s=1<i.childNodes.length?$t.splitTree(i, {node: n.parentNode, offset: $t.position(n)+1}, {isSkipPaddingBlankHTML: !0}):null; const a=$t.splitTree(i, {node: o.parentNode, offset: $t.position(o)}, {isSkipPaddingBlankHTML: !0}); e=c?$t.listDescendant(a, $t.isLi):B.from(a.childNodes).filter($t.isLi), !c&&$t.isList(i.parentNode)||(e=e.map(function(t) {
            return $t.replace(t, 'P');
          })), C.each(B.from(e).reverse(), function(t, e) {
            $t.insertAfter(e, i);
          }); const l=B.compact([i, a, s]); C.each(l, function(t, e) {
            const o=[e].concat($t.listDescendant(e, $t.isList)); C.each(o.reverse(), function(t, e) {
    ...
    function t(t) {
      ...
      const o=$t.createText(new Array(e+1).join($t.NBSP_CHAR)); (t=t.deleteContents()).insertNode(o, !0), (t=At.create(o, e)).select();
    }, t.prototype.insertParagraph=function(t, e) {
      e=(e=(e=e||At.create(t)).deleteContents()).wrapBodyInlineWithPara(); let o; const n=$t.ancestor(e.sc, $t.isPara); if (n) {
        if ($t.isEmpty(n)&&$t.isLi(n)) return void this.bullet.toggleList(n.parentNode.nodeName); let i=null; if (1===this.options.blockquoteBreakingLevel?i=$t.ancestor(n, $t.isBlockquote):2===this.options.blockquoteBreakingLevel&&(i=$t.lastAncestor(n, $t.isBlockquote)), i) {
          o=C($t.emptyPara)[0], $t.isRightEdgePoint(e.getStartPoint())&&$t.isBR(e.sc.nextSibling)&&C(e.sc.nextSibling).remove(); const r=$t.splitTree(i, e.getStartPoint(), {isDiscardEmptySplits: !0}); r?r.parentNode.insertBefore(o, r):$t.insertAfter(o, i);
        } else {
          o=$t.splitTree(n, e.getStartPoint()); let s=$t.listDescendant(n, $t.isEmptyAnchor); s=s.concat($t.listDescendant(o, $t.isEmptyAnchor)), C.each(s, function(t, e) {
            $t.remove(e);
          }), ($t.isHeading(o)||$t.isPre(o)||$t.isCustomStyleTag(o))&&$t.isEmpty(o)&&(o=$t.replace(o, 'p'));
        }
      } else {
        const a=e.sc.childNodes[e.so]; o=C($t.emptyPara)[0], a?e.sc.insertBefore(o, a):e.sc.appendChild(o);
      }At.create(o, 0).normalize().select().scrollIntoView(t);
    }, t;
  }(); var Mt=function(t, h, p, i) {
    const f={colPos: 0, rowPos: 0}; const m=[]; const g=[]; function v(t, e, o, n, i, r, s) {
      const a={baseRow: o, baseCell: n, isRowSpan: i, isColSpan: r, isVirtual: s}; m[t]||(m[t]=[]), m[t][e]=a;
    } function b(t, e) {
      if (!m[t]) return e; if (!m[t][e]) return e; for (let o=e; m[t][o];) if (o++, !m[t][o]) return o;
    } function r(t, e) {
      const o=b(t.rowIndex, e.cellIndex); const n=1<e.colSpan; const i=1<e.rowSpan; const r=t.rowIndex===f.rowPos&&e.cellIndex===f.colPos; v(t.rowIndex, o, t, e, i, n, !1); const s=e.attributes.rowSpan?parseInt(e.attributes.rowSpan.value, 10):0; if (1<s) {
        for (let a=1; a<s; a++) {
          const l=t.rowIndex+a; y(l, o, e, r), v(l, o, t, e, !0, n, !0);
        }
      } const c=e.attributes.colSpan?parseInt(e.attributes.colSpan.value, 10):0; if (1<c) {
        for (let d=1; d<c; d++) {
          const u=b(t.rowIndex, o+d); y(t.rowIndex, u, e, r), v(t.rowIndex, u, t, e, i, !0, !0);
        }
      }
    } function y(t, e, o, n) {
      ...
      for (var t, e, o, n=h===Mt.where.Row?f.rowPos:-1, i=h===Mt.where.Column?f.colPos:-1, r=0, s=!0; s;) {
        const a=0<=n?n:r; const l=0<=i?i:r; const c=m[a]; if (!c) return s=!1, g; const d=c[l]; if (!d) return s=!1, g; let u=Mt.resultAction.Ignore; switch (p) {
          case Mt.requestAction.Add: u=C(d); break; case Mt.requestAction.Delete: u=k(d);
      ...
      for (let t=i.rows, e=0; e<t.length; e++) for (let o=t[e].cells, n=0; n<o.length; n++)r(t[e], o[n]);
    }();
    ...
    function t() {} return t.prototype.tab=function(t, e) {
      const o=$t.ancestor(t.commonAncestor(), $t.isCell); const n=$t.ancestor(o, $t.isTable); const i=$t.listDescendant(n, $t.isCell); const r=B[e?'prev':'next'](i, o); r&&At.create(r, 0).select();
      ...
      for (var o=$t.ancestor(t.commonAncestor(), $t.isCell), n=C(o).closest('tr'), i=this.recoverAttributes(n), r=C('<tr'+i+'></tr>'), s=new Mt(o, Mt.where.Row, Mt.requestAction.Add, C(n).closest('table')[0]).getActionList(), a=0; a<s.length; a++) {
        const l=s[a]; const c=this.recoverAttributes(l.baseCell); switch (l.action) {
          case Mt.resultAction.AddCell: r.append('<td'+c+'>'+$t.blank+'</td>'); break; case Mt.resultAction.SumSpanCount: if ('top'===e) {
            if ((l.baseCell.parent?l.baseCell.closest('tr').rowIndex:0)<=n[0].rowIndex) {
              const d=C('<div></div>').append(C('<td'+c+'>'+$t.blank+'</td>').removeAttr('rowspan')).html(); r.append(d); break;
            }
          } var u=parseInt(l.baseCell.rowSpan, 10); u++, l.baseCell.setAttribute('rowSpan', u);
        }
      } if ('top'===e)n.before(r); else {
        if (1<o.rowSpan) {
          const h=n[0].rowIndex+(o.rowSpan-2); return void C(C(n).parent().find('tr')[h]).after(C(r));
        }n.after(r);
      }
    }, t.prototype.addCol=function(t, e) {
      const o=$t.ancestor(t.commonAncestor(), $t.isCell); const n=C(o).closest('tr'); C(n).siblings().push(n); for (let i=new Mt(o, Mt.where.Column, Mt.requestAction.Add, C(n).closest('table')[0]).getActionList(), r=0; r<i.length; r++) {
        const s=i[r]; const a=this.recoverAttributes(s.baseCell); switch (s.action) {
          case Mt.resultAction.AddCell: 'right'===e?C(s.baseCell).after('<td'+a+'>'+$t.blank+'</td>'):C(s.baseCell).before('<td'+a+'>'+$t.blank+'</td>'); break; case Mt.resultAction.SumSpanCount: if ('right'===e) {
            let l=parseInt(s.baseCell.colSpan, 10); l++, s.baseCell.setAttribute('colSpan', l);
      ...
      for (var e=$t.ancestor(t.commonAncestor(), $t.isCell), o=C(e).closest('tr'), n=o.children('td, th').index(C(e)), i=o[0].rowIndex, r=new Mt(e, Mt.where.Row, Mt.requestAction.Delete, C(o).closest('table')[0]).getActionList(), s=0; s<r.length; s++) {
        if (r[s]) {
          const a=r[s].baseCell; const l=r[s].virtualTable; const c=a.rowSpan&&1<a.rowSpan; let d=c?parseInt(a.rowSpan, 10):0; switch (r[s].action) {
            case Mt.resultAction.Ignore: continue; case Mt.resultAction.AddCell: var u=o.next('tr')[0]; if (!u) continue; var h=o[0].cells[n]; c&&(2<d?(d--, u.insertBefore(h, u.cells[n]), u.cells[n].setAttribute('rowSpan', d), u.cells[n].innerHTML=''):2===d&&(u.insertBefore(h, u.cells[n]), u.cells[n].removeAttribute('rowSpan'), u.cells[n].innerHTML='')); continue; case Mt.resultAction.SubtractSpanCount: c&&(2<d?(d--, a.setAttribute('rowSpan', d), l.rowIndex!==i&&a.cellIndex===n&&(a.innerHTML='')):2===d&&(a.removeAttribute('rowSpan'), l.rowIndex!==i&&a.cellIndex===n&&(a.innerHTML=''))); continue; case Mt.resultAction.RemoveCell: continue;
          }
        }
      }o.remove();
    }, t.prototype.deleteCol=function(t) {
      for (let e=$t.ancestor(t.commonAncestor(), $t.isCell), o=C(e).closest('tr'), n=o.children('td, th').index(C(e)), i=new Mt(e, Mt.where.Column, Mt.requestAction.Delete, C(o).closest('table')[0]).getActionList(), r=0; r<i.length; r++) {
        if (i[r]) {
          switch (i[r].action) {
            case Mt.resultAction.Ignore: continue; case Mt.resultAction.SubtractSpanCount: var s=i[r].baseCell; if (s.colSpan&&1<s.colSpan) {
              let a=s.colSpan?parseInt(s.colSpan, 10):0; 2<a?(a--, s.setAttribute('colSpan', a), s.cellIndex===n&&(s.innerHTML='')):2===a&&(s.removeAttribute('colSpan'), s.cellIndex===n&&(s.innerHTML=''));
            } continue; case Mt.resultAction.RemoveCell: $t.remove(i[r].baseCell, !0); continue;
          }
        }
      }
    }, t.prototype.createTable=function(t, e, o) {
      for (var n, i=[], r=0; r<t; r++)i.push('<td>'+$t.blank+'</td>'); n=i.join(''); for (var s, a=[], l=0; l<e; l++)a.push('<tr>'+n+'</tr>'); s=a.join(''); const c=C('<table>'+s+'</table>'); return o&&o.tableClassName&&c.addClass(o.tableClassName), c[0];
    }, t.prototype.deleteTable=function(t) {
      const e=$t.ancestor(t.commonAncestor(), $t.isCell); C(e).closest('table').remove();
    }, t;
  }(); const jt=function() {
    function t(t) {
      const u=this; this.context=t, this.$note=t.layoutInfo.note, this.$editor=t.layoutInfo.editor, this.$editable=t.layoutInfo.editable, this.options=t.options, this.lang=this.options.langInfo, this.editable=this.$editable[0], this.lastRange=null, this.style=new Dt, this.table=new Ut, this.typing=new zt(t), this.bullet=new Bt, this.history=new Ht(this.$editable), this.context.memo('help.undo', this.lang.help.undo), this.context.memo('help.redo', this.lang.help.redo), this.context.memo('help.tab', this.lang.help.tab), this.context.memo('help.untab', this.lang.help.untab), this.context.memo('help.insertParagraph', this.lang.help.insertParagraph), this.context.memo('help.insertOrderedList', this.lang.help.insertOrderedList), this.context.memo('help.insertUnorderedList', this.lang.help.insertUnorderedList), this.context.memo('help.indent', this.lang.help.indent), this.context.memo('help.outdent', this.lang.help.outdent), this.context.memo('help.formatPara', this.lang.help.formatPara), this.context.memo('help.insertHorizontalRule', this.lang.help.insertHorizontalRule), this.context.memo('help.fontName', this.lang.help.fontName); for (var e=['bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'formatBlock', 'removeFormat', 'backColor'], o=0, n=e.length; o<n; o++) {
        this[e[o]]=function(e) {
          return function(t) {
        ...
        if (!u.isLimited(t.length)) {
          const e=u.getLastRange().insertNode($t.createText(t)); At.create(e, $t.nodeLength(e)).select(), u.setLastRange();
        }
      }), this.pasteHTML=this.wrapCommand(function(t) {
        if (!u.isLimited(t.length)) {
          t=u.context.invoke('codeview.purify', t); const e=u.getLastRange().pasteHTML(t); At.createFromNodeAfter(B.last(e)).select(), u.setLastRange();
        }
      }), this.formatBlock=this.wrapCommand(function(t, e) {
        const o=u.options.callbacks.onApplyCustomStyle; o?o.call(u, e, u.context, u.onFormatBlock):u.onFormatBlock(t, e);
      }), this.insertHorizontalRule=this.wrapCommand(function() {
        const t=u.getLastRange().insertNode($t.create('HR')); t.nextSibling&&(At.create(t.nextSibling, 0).normalize().select(), u.setLastRange());
        ...
        let o=t.url; const e=t.text; const n=t.isNewWindow; let i=t.range||u.getLastRange(); const r=e.length-i.toString().length; if (!(0<r&&u.isLimited(r))) {
          const s=i.toString()!==e; 'string'==typeof o&&(o=o.trim()), o=u.options.onCreateLink?u.options.onCreateLink(o):/^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(o)?o:'http://'+o; let a=[]; if (s) {
            const l=(i=i.deleteContents()).insertNode(C('<A>'+e+'</A>')[0]); a.push(l);
          ...
          }); const c=At.createFromNodeBefore(B.head(a)).getStartPoint(); const d=At.createFromNodeAfter(B.last(a)).getEndPoint(); At.create(c.node, c.offset, d.node, d.offset).select(), u.setLastRange();
        }
        ...
        const e=t.split('x'); u.getLastRange().deleteContents().insertNode(u.table.createTable(e[0], e[1], u.options));
      }), this.removeMedia=this.wrapCommand(function() {
        let t=C(u.restoreTarget()).parent(); t.parent('figure').length?t.parent('figure').remove():t=C(u.restoreTarget()).detach(), u.context.triggerEvent('media.delete', t, u.$editable);
      }), this.floatMe=this.wrapCommand(function(t) {
        const e=C(u.restoreTarget()); e.toggleClass('note-float-left', 'left'===t), e.toggleClass('note-float-right', 'right'===t), e.css('float', 'none'===t?'':t);
      }), this.resize=this.wrapCommand(function(t) {
        const e=C(u.restoreTarget()); 0===(t=parseFloat(t))?e.css('width', ''):e.css({width: 100*t+'%', height: ''});
      });
    } return t.prototype.initialize=function() {
      const e=this; this.$editable.on('keydown', function(t) {
      ...
      const e=this.options.keyMap[R.isMac?'mac':'pc']; const o=[]; t.metaKey&&o.push('CMD'), t.ctrlKey&&!t.altKey&&o.push('CTRL'), t.shiftKey&&o.push('SHIFT'); const n=Pt.nameFromCode[t.keyCode]; n&&o.push(n); const i=e[o.join('+')]; i?!1!==this.context.invoke(i)&&t.preventDefault():Pt.isEdit(t.keyCode)&&this.afterCommand();
      ...
      let o; const n=this; return (o=t, C.Deferred(function(t) {
        const e=C('<img>'); e.one('load', function() {
      ...
      const i=this; C.each(t, function(t, e) {
        let n; const o=e.name; i.options.maximumImageFileSize&&i.options.maximumImageFileSize<e.size?i.context.triggerEvent('image.upload.error', i.lang.image.maximumFileSizeError):(n=e, C.Deferred(function(o) {
          C.extend(new FileReader, {onload: function(t) {
            const e=t.target.result; o.resolve(e);
          }, onerror: function(t) {
            o.reject(t);
          }}).readAsDataURL(n);
        }).promise()).then(function(t) {
...
this.options.callbacks.onImageUpload?this.context.triggerEvent('image.upload', t):this.insertImagesAsDataURL(t);
      ...
      let t=this.getLastRange(); return t.isOnAnchor()&&(t=At.createFromNode($t.ancestor(t.sc, $t.isAnchor))), t.toString();
      ...
      if (document.execCommand('FormatBlock', !1, R.isMSIE?'<'+t+'>':t), e&&e.length&&(e[0].tagName.toUpperCase()!==t.toUpperCase()&&(e=e.find(t)), e&&e.length)) {
        const o=e[0].className||''; if (o) {
          const n=this.createRange(); C([n.sc, n.ec]).closest(t).addClass(o);
        }
      }
    }, t.prototype.formatPara=function() {
      this.formatBlock('P');
    }, t.prototype.fontStyling=function(t, e) {
      const o=this.getLastRange(); if (o) {
        const n=this.style.styleNodes(o); if (C(n).css(t, e), o.isCollapsed()) {
          const i=B.head(n); i&&!$t.nodeLength(i)&&(i.innerHTML=$t.ZERO_WIDTH_NBSP_CHAR, At.createFromNodeAfter(i.firstChild).select(), this.setLastRange(), this.$editable.data('bogus', i));
        }
      }
    }, t.prototype.unlink=function() {
      let t=this.getLastRange(); if (t.isOnAnchor()) {
        const e=$t.ancestor(t.sc, $t.isAnchor); (t=At.createFromNode(e)).select(), this.setLastRange(), this.beforeCommand(), document.execCommand('unlink'), this.afterCommand();
      }
    }, t.prototype.getLinkInfo=function() {
      const t=this.getLastRange().expand($t.isAnchor); const e=C(B.head(t.nodes($t.isAnchor))); const o={range: t, text: t.toString(), url: e.length?e.attr('href'):''}; return e.length&&(o.isNewWindow='_blank'===e.attr('target')), o;
    ...
    function t(t) {
      ...
      const e=t.originalEvent.clipboardData; if (e&&e.items&&e.items.length) {
        const o=1<e.items.length?e.items[1]:B.head(e.items); 'file'===o.kind&&-1!==o.type.indexOf('image/')&&this.context.invoke('editor.insertImagesOrCallback', [o.getAsFile()]), this.context.invoke('editor.afterCommand');
      }
    }, t;
  }(); const Wt=function() {
    function t(t) {
...
this.options.disableDragAndDrop?(this.documentEventHandlers.onDrop=function(t) {
  t.preventDefault();
      ...
      const i=this; let n=C(); const r=this.$dropzone.find('.note-dropzone-message'); this.documentEventHandlers.onDragenter=function(t) {
        const e=i.context.invoke('codeview.isActivated'); const o=0<i.$editor.width()&&0<i.$editor.height(); e||n.length||!o||(i.$editor.addClass('dragover'), i.$dropzone.width(i.$editor.width()), i.$dropzone.height(i.$editor.height()), r.text(i.lang.image.dragImageHere)), n=n.add(t.target);
        ...
        const n=t.originalEvent.dataTransfer; t.preventDefault(), n&&n.files&&n.files.length?(i.$editable.focus(), i.context.invoke('editor.insertImagesOrCallback', n.files)):C.each(n.types, function(t, e) {
          const o=n.getData(e); -1<e.toLowerCase().indexOf('text')?i.context.invoke('editor.pasteHTML', o):C(o).each(function(t, e) {
            i.context.invoke('editor.insertNode', e);
          });
        });
      }).on('dragover', !1);
    }, t.prototype.destroy=function() {
      const e=this; Object.keys(this.documentEventHandlers).forEach(function(t) {
        e.$eventListener.off(t.substr(2).toLowerCase(), e.documentEventHandlers[t]);
      }), this.documentEventHandlers={};
    }, t;
  }(); R.hasCodeMirror&&(Ot=window.CodeMirror); const Vt=function() {
    function t(t) {
...
this.isActivated()?this.deactivate():this.activate(), this.context.triggerEvent('codeview.toggled');
      ...
      if (this.options.codeviewFilter&&(t=t.replace(this.options.codeviewFilterRegex, ''), this.options.codeviewIframeFilter)) {
        const i=this.options.codeviewIframeWhitelistSrc.concat(this.options.codeviewIframeWhitelistSrcBase); t=t.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function(t) {
          if (/<.+src(?==?('|"|\s)?)[\s\S]+src(?=('|"|\s)?)[^>]*?>/i.test(t)) return ''; for (let e=0, o=i; e<o.length; e++) {
            const n=o[e]; if (new RegExp('src="(https?:)?//'+n.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&')+'/(.+)"').test(t)) return t;
          } return '';
        });
      } return t;
    }, t.prototype.activate=function() {
      const e=this; if (this.$codable.val($t.html(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke('toolbar.updateCodeview', !0), this.$editor.addClass('codeview'), this.$codable.focus(), R.hasCodeMirror) {
        const o=Ot.fromTextArea(this.$codable[0], this.options.codemirror); if (this.options.codemirror.tern) {
          const n=new Ot.TernServer(this.options.codemirror.tern); o.ternServer=n, o.on('cursorActivity', function(t) {
            n.updateArgHints(t);
          });
      ...
      } const e=this.purify($t.value(this.$codable, this.options.prettifyHtml)||$t.emptyPara); const o=this.$editable.html()!==e; this.$editable.html(e), this.$editable.height(this.options.height?this.$codable.height():'auto'), this.$editor.removeClass('codeview'), o&&this.context.triggerEvent('change', this.$editable.html(), this.$editable), this.$editable.focus(), this.context.invoke('toolbar.updateCodeview', !1);
    }, t.prototype.destroy=function() {
    ...
    function t(t) {
      ...
      const n=this; this.options.airMode||this.options.disableResizeEditor?this.destroy():this.$statusbar.on('mousedown', function(t) {
        t.preventDefault(), t.stopPropagation(); const o=n.$editable.offset().top-n.$document.scrollTop(); const e=function(t) {
          let e=t.clientY-(o+24); e=0<n.options.minheight?Math.max(e, n.options.minheight):e, e=0<n.options.maxHeight?Math.min(e, n.options.maxHeight):e, n.$editable.height(e);
    ...
    function t(t) {
      const e=this; this.context=t, this.$editor=t.layoutInfo.editor, this.$toolbar=t.layoutInfo.toolbar, this.$editable=t.layoutInfo.editable, this.$codable=t.layoutInfo.codable, this.$window=C(window), this.$scrollbar=C('html, body'), this.onResize=function() {
    ...
    function t(t) {
      const o=this; this.context=t, this.$document=C(document), this.$editingArea=t.layoutInfo.editingArea, this.options=t.options, this.lang=this.options.langInfo, this.events={'summernote.mousedown': function(t, e) {
      ...
      if (this.context.isDisabled()) return !1; const o=$t.isImg(t); const n=this.$handle.find('.note-control-selection'); if (this.context.invoke('imagePopover.update', t, e), o) {
        const i=C(t); const r=i.position(); const s={left: r.left+parseInt(i.css('marginLeft'), 10), top: r.top+parseInt(i.css('marginTop'), 10)}; const a={w: i.outerWidth(!1), h: i.outerHeight(!1)}; n.css({display: 'block', left: s.left, top: s.top, width: a.w, height: a.h}).data('target', i); const l=new Image; l.src=i.attr('src'); const c=a.w+'x'+a.h+' ('+this.lang.image.original+': '+l.width+'x'+l.height+')'; n.find('.note-control-selection-info').text(c), this.context.invoke('editor.saveTarget', t);
    ...
    function t(t) {
      const o=this; this.context=t, this.events={'summernote.keyup': function(t, e) {
      ...
      if (this.lastWordRange) {
        const t=this.lastWordRange.toString(); const e=t.match(Zt); if (e&&(e[1]||e[2])) {
          const o=e[1]?t:'http://'+t; const n=C('<a />').html(t).attr('href', o)[0]; this.context.options.linkTargetBlank&&C(n).attr('target', '_blank'), this.lastWordRange.insertNode(n), this.lastWordRange=null, this.context.invoke('editor.focus');
        }
      }
    ...
    function t(t) {
      const o=this; this.context=t, this.options=t.options.replace||{}, this.keys=[Pt.code.ENTER, Pt.code.SPACE, Pt.code.PERIOD, Pt.code.COMMA, Pt.code.SEMICOLON, Pt.code.SLASH], this.previousKeydownCode=null, this.events={'summernote.keyup': function(t, e) {
        e.isDefaultPrevented()||o.handleKeyup(e);
      }, 'summernote.keydown': function(t, e) {
        o.handleKeydown(e);
      }};
      ...
      if (this.lastWord) {
        const o=this; const t=this.lastWord.toString(); this.options.match(t, function(t) {
          if (t) {
            let e=''; if ('string'==typeof t?e=$t.createText(t):t instanceof jQuery?e=t[0]:t instanceof Node&&(e=t), !e) return; o.lastWord.insertNode(e), o.lastWord=null, o.context.invoke('editor.focus');
          }
        });
      }
    }, t.prototype.handleKeydown=function(t) {
    ...
    function t(t) {
      ...
      const t=this; this.$placeholder=C('<div class="note-placeholder">'), this.$placeholder.on('click', function() {
    ...
    function t(t) {
      ...
      let e=this.invertedKeyMap[t]; return this.options.shortcuts&&e?(R.isMac&&(e=e.replace('CMD', '⌘').replace('SHIFT', '⇧')), ' ('+(e=e.replace('BACKSLASH', '\\').replace('SLASH', '/').replace('LEFTBRACKET', '[').replace('RIGHTBRACKET', ']'))+')'):'';
      ...
      const p=this; return this.ui.buttonGroup({className: 'note-color '+h, children: [this.button({className: 'note-current-color-button', contents: this.ui.icon(this.options.icons.font+' note-recent-color'), tooltip: t, click: function(t) {
        const e=C(t.currentTarget); o&&n?p.context.invoke('editor.color', {backColor: e.attr('data-backColor'), foreColor: e.attr('data-foreColor')}):o?p.context.invoke('editor.color', {backColor: e.attr('data-backColor')}):n&&p.context.invoke('editor.color', {foreColor: e.attr('data-foreColor')});
      }, callback: function(t) {
        const e=t.find('.note-recent-color'); o&&(e.css('background-color', p.options.colorButton.backColor), t.attr('data-backColor', p.options.colorButton.backColor)), n?(e.css('color', p.options.colorButton.foreColor), t.attr('data-foreColor', p.options.colorButton.foreColor)):e.css('color', 'transparent');
      }}), this.button({className: 'dropdown-toggle', contents: this.ui.dropdownButtonContents('', this.options), tooltip: this.lang.color.more, data: {toggle: 'dropdown'}}), this.ui.dropdown({items: (o?['<div class="note-palette">', '  <div class="note-palette-title">'+this.lang.color.background+'</div>', '  <div>', '    <button type="button" class="note-color-reset btn btn-light" data-event="backColor" data-value="inherit">', this.lang.color.transparent, '    </button>', '  </div>', '  <div class="note-holder" data-event="backColor"/>', '  <div>', '    <button type="button" class="note-color-select btn" data-event="openPalette" data-value="backColorPicker">', this.lang.color.cpSelect, '    </button>', '    <input type="color" id="backColorPicker" class="note-btn note-color-select-btn" value="'+this.options.colorButton.backColor+'" data-event="backColorPalette">', '  </div>', '  <div class="note-holder-custom" id="backColorPalette" data-event="backColor"/>', '</div>'].join(''):'')+(n?['<div class="note-palette">', '  <div class="note-palette-title">'+this.lang.color.foreground+'</div>', '  <div>', '    <button type="button" class="note-color-reset btn btn-light" data-event="removeFormat" data-value="foreColor">', this.lang.color.resetToDefault, '    </button>', '  </div>', '  <div class="note-holder" data-event="foreColor"/>', '  <div>', '    <button type="button" class="note-color-select btn" data-event="openPalette" data-value="foreColorPicker">', this.lang.color.cpSelect, '    </button>', '    <input type="color" id="foreColorPicker" class="note-btn note-color-select-btn" value="'+this.options.colorButton.foreColor+'" data-event="foreColorPalette">', '  <div class="note-holder-custom" id="foreColorPalette" data-event="foreColor"/>', '</div>'].join(''):''), callback: function(o) {
        o.find('.note-holder').each(function(t, e) {
          const o=C(e); o.append(p.ui.palette({colors: p.options.colors, colorsName: p.options.colorsName, eventName: o.data('event'), container: p.options.container, tooltip: p.options.tooltip}).render());
        }); const n=[['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF']]; o.find('.note-holder-custom').each(function(t, e) {
          const o=C(e); o.append(p.ui.palette({colors: n, colorsName: n, eventName: o.data('event'), container: p.options.container, tooltip: p.options.tooltip}).render());
        }), o.find('input[type=color]').each(function(t, e) {
          C(e).change(function() {
            const t=o.find('#'+C(this).data('event')).find('.note-color-btn').first(); const e=this.value.toUpperCase(); t.css('background-color', e).attr('aria-label', e).attr('data-value', e).attr('data-original-title', e), t.click();
          });
        });
      }, click: function(t) {
        t.stopPropagation(); const e=C('.'+h); const o=C(t.target); const n=o.data('event'); const i=o.attr('data-value'); if ('openPalette'===n) {
          const r=e.find('#'+i); const s=C(e.find('#'+r.data('event')).find('.note-color-row')[0]); const a=s.find('.note-color-btn').last().detach(); const l=r.val(); a.css('background-color', l).attr('aria-label', l).attr('data-value', l).attr('data-original-title', l), s.prepend(a), r.click();
        } else if (B.contains(['backColor', 'foreColor'], n)) {
          const c='backColor'===n?'background-color':'color'; const d=o.closest('.note-color').find('.note-recent-color'); const u=o.closest('.note-color').find('.note-current-color-button'); d.css(c, i), u.attr('data-'+n, i), p.context.invoke('editor.'+n, i);
        }
      }})]}).render();
    }, t.prototype.addToolbarButtons=function() {
      const n=this; this.context.memo('button.style', function() {
        return n.ui.buttonGroup([n.button({className: 'dropdown-toggle', contents: n.ui.dropdownButtonContents(n.ui.icon(n.options.icons.magic), n.options), tooltip: n.lang.style.style, data: {toggle: 'dropdown'}}), n.ui.dropdown({className: 'dropdown-style', items: n.options.styleTags, title: n.lang.style.style, template: function(t) {
          'string'==typeof t&&(t={tag: t, title: n.lang.style.hasOwnProperty(t)?n.lang.style[t]:t}); const e=t.tag; const o=t.title; return '<'+e+(t.style?' style="'+t.style+'" ':'')+(t.className?' class="'+t.className+'"':'')+'>'+o+'</'+e+'>';
        }, click: n.context.createInvokeHandler('editor.formatBlock')})]).render();
      }); for (var t=function(t, e) {
          const o=i.options.styleTags[t]; i.context.memo('button.style.'+o, function() {
        ...
        }, i=this, e=0, o=this.options.styleTags.length; e<o; e++)t(e); this.context.memo('button.bold', function() {
        ...
        const t=n.context.invoke('editor.currentStyle'); return C.each(t['font-family'].split(','), function(t, e) {
          e=e.trim().replace(/['"]+/g, ''), n.isFontDeservedToAdd(e)&&-1===n.options.fontNames.indexOf(e)&&n.options.fontNames.push(e);
        }), n.ui.buttonGroup([n.button({className: 'dropdown-toggle', contents: n.ui.dropdownButtonContents('<span class="note-current-fontname"/>', n.options), tooltip: n.lang.font.name, data: {toggle: 'dropdown'}}), n.ui.dropdownCheck({className: 'dropdown-fontname', checkClassName: n.options.icons.menuCheck, items: n.options.fontNames.filter(n.isFontInstalled.bind(n)), title: n.lang.font.name, template: function(t) {
      ...
      }); const r=this.button({contents: this.ui.icon(this.options.icons.alignLeft), tooltip: this.lang.paragraph.left+this.representShortcut('justifyLeft'), click: this.context.createInvokeHandler('editor.justifyLeft')}); const s=this.button({contents: this.ui.icon(this.options.icons.alignCenter), tooltip: this.lang.paragraph.center+this.representShortcut('justifyCenter'), click: this.context.createInvokeHandler('editor.justifyCenter')}); const a=this.button({contents: this.ui.icon(this.options.icons.alignRight), tooltip: this.lang.paragraph.right+this.representShortcut('justifyRight'), click: this.context.createInvokeHandler('editor.justifyRight')}); const l=this.button({contents: this.ui.icon(this.options.icons.alignJustify), tooltip: this.lang.paragraph.justify+this.representShortcut('justifyFull'), click: this.context.createInvokeHandler('editor.justifyFull')}); const c=this.button({contents: this.ui.icon(this.options.icons.outdent), tooltip: this.lang.paragraph.outdent+this.representShortcut('outdent'), click: this.context.createInvokeHandler('editor.outdent')}); const d=this.button({contents: this.ui.icon(this.options.icons.indent), tooltip: this.lang.paragraph.indent+this.representShortcut('indent'), click: this.context.createInvokeHandler('editor.indent')}); this.context.memo('button.justifyLeft', A.invoke(r, 'render')), this.context.memo('button.justifyCenter', A.invoke(s, 'render')), this.context.memo('button.justifyRight', A.invoke(a, 'render')), this.context.memo('button.justifyFull', A.invoke(l, 'render')), this.context.memo('button.outdent', A.invoke(c, 'render')), this.context.memo('button.indent', A.invoke(d, 'render')), this.context.memo('button.paragraph', function() {
        ...
        return n.ui.buttonGroup([n.button({className: 'dropdown-toggle', contents: n.ui.dropdownButtonContents(n.ui.icon(n.options.icons.table), n.options), tooltip: n.lang.table.table, data: {toggle: 'dropdown'}}), n.ui.dropdown({title: n.lang.table.table, className: 'note-table', items: ['<div class="note-dimension-picker">', '  <div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"/>', '  <div class="note-dimension-picker-highlighted"/>', '  <div class="note-dimension-picker-unhighlighted"/>', '</div>', '<div class="note-dimension-display">1 x 1</div>'].join('')})], {callback: function(t) {
      ...
      const n=this; const e=t||this.$toolbar; const o=this.context.invoke('editor.currentStyle'); if (this.updateBtnStates(e, {'.note-btn-bold': function() {
        ...
        const i=o['font-family'].split(',').map(function(t) {
          return t.replace(/[\'\"]/g, '').replace(/\s+$/, '').replace(/^\s+/, '');
        }); const r=B.find(i, this.isFontInstalled.bind(this)); e.find('.dropdown-fontname a').each(function(t, e) {
          const o=C(e); const n=o.data('value')+''==r+''; o.toggleClass('checked', n);
        }), e.find('.note-current-fontname').text(r).css('font-family', r);
      } if (o['font-size']) {
        const s=o['font-size']; e.find('.dropdown-fontsize a').each(function(t, e) {
          const o=C(e); const n=o.data('value')+''==s+''; o.toggleClass('checked', n);
        }), e.find('.note-current-fontsize').text(s);
      } if (o['line-height']) {
        const a=o['line-height']; e.find('.dropdown-line-height li a').each(function(t, e) {
          const o=C(e).data('value')+''==a+''; n.className=o?'checked':'';
        });
      }
    }, t.prototype.updateBtnStates=function(o, t) {
      const n=this; C.each(t, function(t, e) {
        n.ui.toggleBtnActive(o.find(t), e());
      });
    }, t.prototype.tableMoveHandler=function(t) {
      let e; const o=C(t.target.parentNode); const n=o.next(); const i=o.find('.note-dimension-picker-mousecatcher'); const r=o.find('.note-dimension-picker-highlighted'); const s=o.find('.note-dimension-picker-unhighlighted'); if (void 0===t.offsetX) {
        const a=C(t.target).offset(); e={x: t.pageX-a.left, y: t.pageY-a.top};
      } else e={x: t.offsetX, y: t.offsetY}; const l=Math.ceil(e.x/18)||1; const c=Math.ceil(e.y/18)||1; r.css({width: l+'em', height: c+'em'}), i.data('value', l+'x'+c), 3<l&&l<this.options.insertTableMaxSize.col&&s.css({width: l+1+'em'}), 3<c&&c<this.options.insertTableMaxSize.row&&s.css({height: c+1+'em'}), n.html(l+' x '+c);
    }, t;
  }(); const ee=function() {
    function t(t) {
      ...
      if (this.$editor.hasClass('fullscreen')) return !1; const t=this.$editor.outerHeight(); const e=this.$editor.width(); const o=this.$toolbar.height(); const n=this.$statusbar.height(); let i=0; this.options.otherStaticBar&&(i=C(this.options.otherStaticBar).outerHeight()); const r=this.$document.scrollTop(); const s=this.$editor.offset().top; const a=s-i; const l=s+t-i-o-n; !this.isFollowing&&a<r&&r<l-o?(this.isFollowing=!0, this.$toolbar.css({position: 'fixed', top: i, width: e}), this.$editable.css({marginTop: this.$toolbar.height()+5})):this.isFollowing&&(r<a||l<r)&&(this.isFollowing=!1, this.$toolbar.css({position: 'relative', top: 0, width: '100%'}), this.$editable.css({marginTop: ''}));
...
t?this.$toolbar.prependTo(this.$editor):this.options.toolbarContainer&&this.$toolbar.appendTo(this.options.toolbarContainer), this.followScroll();
    ...
    function t(t) {
      ...
      const a=this; return C.Deferred(function(e) {
        const o=a.$dialog.find('.note-link-text'); const n=a.$dialog.find('.note-link-url'); const i=a.$dialog.find('.note-link-btn'); const r=a.$dialog.find('.sn-checkbox-open-in-new-window input[type=checkbox]'); a.ui.onDialogShown(a.$dialog, function() {
          ...
          }).val(s.url), R.isSupportTouch||n.trigger('focus'), a.toggleLinkBtn(i, o, n), a.bindEnterKey(n, i), a.bindEnterKey(o, i); const t=void 0!==s.isNewWindow?s.isNewWindow:a.context.options.linkTargetBlank; r.prop('checked', t), i.one('click', function(t) {
      ...
      const e=this; const t=this.context.invoke('editor.getLinkInfo'); this.context.invoke('editor.saveRange'), this.showLinkDialog(t).then(function(t) {
    ...
    function t(t) {
      const e=this; this.context=t, this.ui=C.summernote.ui, this.options=t.options, this.events={'summernote.keyup summernote.mouseup summernote.change summernote.scroll': function() {
        e.update();
      ...
      if (this.context.invoke('editor.hasFocus')) {
        const t=this.context.invoke('editor.getLastRange'); if (t.isCollapsed()&&t.isOnAnchor()) {
          const e=$t.ancestor(t.sc, $t.isAnchor); const o=C(e).attr('href'); this.$popover.find('a').attr('href', o).html(o); const n=$t.posFromPlaceholder(e); this.$popover.css({display: 'block', left: n.left, top: n.top});
        } else this.hide();
      } else this.hide();
    }, t.prototype.hide=function() {
      this.$popover.hide();
    ...
    function t(t) {
      ...
      const e=this; this.context.invoke('editor.saveRange'), this.showImageDialog().then(function(t) {
      ...
      const i=this; return C.Deferred(function(e) {
        const t=i.$dialog.find('.note-image-input'); const o=i.$dialog.find('.note-image-url'); const n=i.$dialog.find('.note-image-btn'); i.ui.onDialogShown(i.$dialog, function() {
    ...
    function t(t) {
      const e=this; this.context=t, this.ui=C.summernote.ui, this.editable=t.layoutInfo.editable[0], this.options=t.options, this.events={'summernote.disable': function() {
        e.hide();
      }};
    } return t.prototype.shouldInitialize=function() {
      ...
      if ($t.isImg(t)) {
        const o=$t.posFromPlaceholder(t); const n=$t.posFromPlaceholder(this.editable); this.$popover.css({display: 'block', left: this.options.popatmouse?e.pageX-20:o.left, top: this.options.popatmouse?e.pageY:Math.min(o.top, n.top)});
      } else this.hide();
    }, t.prototype.hide=function() {
      this.$popover.hide();
    }, t;
    ...
    function t(t) {
      const o=this; this.context=t, this.ui=C.summernote.ui, this.options=t.options, this.events={'summernote.mousedown': function(t, e) {
        o.update(e.target);
      ...
      this.$popover=this.ui.popover({className: 'note-table-popover'}).render().appendTo(this.options.container); const t=this.$popover.find('.popover-content,.note-popover-content'); this.context.invoke('buttons.build', t, this.options.popover.table), R.isFF&&document.execCommand('enableInlineTableEditing', !1, !1);
    }, t.prototype.destroy=function() {
      this.$popover.remove();
    }, t.prototype.update=function(t) {
      if (this.context.isDisabled()) return !1; const e=$t.isCell(t); if (e) {
        const o=$t.posFromPlaceholder(t); this.$popover.css({display: 'block', left: o.left, top: o.top});
    ...
    function t(t) {
      ...
      let e; const o=t.match(/\/\/(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))([\w|-]{11})(?:(?:[\?&]t=)(\S+))?$/); const n=t.match(/(?:www\.|\/\/)instagram\.com\/p\/(.[a-zA-Z0-9_-]*)/); const i=t.match(/\/\/vine\.co\/v\/([a-zA-Z0-9]+)/); const r=t.match(/\/\/(player\.)?vimeo\.com\/([a-z]*\/)*(\d+)[?]?.*/); const s=t.match(/.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/); const a=t.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/); const l=t.match(/\/\/v\.qq\.com.*?vid=(.+)/); const c=t.match(/\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.html\??.*/); const d=t.match(/^.+.(mp4|m4v)$/); const u=t.match(/^.+.(ogg|ogv)$/); const h=t.match(/^.+.(webm)$/); const p=t.match(/(?:www\.|\/\/)facebook\.com\/([^\/]+)\/videos\/([0-9]+)/); if (o&&11===o[1].length) {
        const f=o[1]; let m=0; if (void 0!==o[2]) {
          const g=o[2].match(/^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/); if (g) for (let v=[3600, 60, 1], b=0, y=v.length; b<y; b++)m+=void 0!==g[b+1]?v[b]*parseInt(g[b+1], 10):0;
        ...
        const k=l&&l[1].length?l[1]:c[2]; e=C('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>').attr('frameborder', 0).attr('height', '310').attr('width', '500').attr('src', 'http://v.qq.com/iframe/player.html?vid='+k+'&amp;auto=0');
      ...
      const o=this; const t=this.context.invoke('editor.getSelectedText'); this.context.invoke('editor.saveRange'), this.showVideoDialog(t).then(function(t) {
        o.ui.hideDialog(o.$dialog), o.context.invoke('editor.restoreRange'); const e=o.createVideoNode(t); e&&o.context.invoke('editor.insertNode', e);
      }).fail(function() {
        o.context.invoke('editor.restoreRange');
      });
    }, t.prototype.showVideoDialog=function(t) {
      const n=this; return C.Deferred(function(e) {
        const o=n.$dialog.find('.note-video-url'); const t=n.$dialog.find('.note-video-btn'); n.ui.onDialogShown(n.$dialog, function() {
    ...
    function t(t) {
      ...
      const n=this; const i=this.options.keyMap[R.isMac?'mac':'pc']; return Object.keys(i).map(function(t) {
        const e=i[t]; const o=C('<div><div class="help-list-item"/></div>'); return o.append(C('<label><kbd>'+t+'</kdb></label>').css({'width': 180, 'margin-right': 10})).append(C('<span/>').html(n.context.memo('help.'+e)||e)), o.html();
      }).join('');
    }, t.prototype.showHelpDialog=function() {
      const e=this; return C.Deferred(function(t) {
    ...
    function t(t) {
      const o=this; this.context=t, this.ui=C.summernote.ui, this.options=t.options, this.events={'summernote.keyup summernote.mouseup summernote.scroll': function() {
        o.update();
      ...
      const t=this.context.invoke('editor.currentStyle'); if (t.range&&!t.range.isCollapsed()) {
        const e=B.last(t.range.getClientRects()); if (e) {
          const o=A.rect2bnd(e); this.$popover.css({display: 'block', left: Math.max(o.left+o.width/2, 0)-20, top: o.top+o.height}), this.context.invoke('buttons.updateCurrentStyle', this.$popover);
        }
      } else this.hide();
    }, t.prototype.hide=function() {
      this.$popover.hide();
    ...
    function t(t) {
      const o=this; this.context=t, this.ui=C.summernote.ui, this.$editable=t.layoutInfo.editable, this.options=t.options, this.hint=this.options.hint||[], this.direction=this.options.hintDirection||'bottom', this.hints=Array.isArray(this.hint)?this.hint:[this.hint], this.events={'summernote.keyup': function(t, e) {
        e.isDefaultPrevented()||o.handleKeyup(e);
      }, 'summernote.keydown': function(t, e) {
        o.handleKeydown(e);
      }, 'summernote.disable summernote.dialog.shown': function() {
      ...
      const e=this; this.lastWordRange=null, this.$popover=this.ui.popover({className: 'note-hint-popover', hideArrow: !0, direction: ''}).render().appendTo(this.options.container), this.$popover.hide(), this.$content=this.$popover.find('.popover-content,.note-popover-content'), this.$content.on('click', '.note-hint-item', function(t) {
      ...
      const e=this.hints[t.data('index')]; const o=t.data('item'); let n=e.content?e.content(o):o; return 'string'==typeof n&&(n=$t.createText(n)), n;
    }, t.prototype.createItemTemplates=function(n, t) {
      const i=this.hints[n]; return t.map(function(t, e) {
        const o=C('<div class="note-hint-item"/>'); return o.append(i.template?i.template(t):t+''), o.data({index: n, item: t}), o;
      });
    }, t.prototype.handleKeydown=function(t) {
      ...
      const o=this; const n=C('<div class="note-hint-group note-hint-group-'+e+'"/>'); return this.searchKeyword(e, t, function(t) {
        (t=t||[]).length&&(n.html(o.createItemTemplates(e, t)), o.show());
      }), n;
    }, t.prototype.handleKeyup=function(t) {
      const o=this; if (!B.contains([Pt.code.ENTER, Pt.code.UP, Pt.code.DOWN], t.keyCode)) {
        const e=this.context.invoke('editor.getLastRange').getWordRange(); const n=e.toString(); if (this.hints.length&&n) {
          this.$content.empty(); const i=A.rect2bnd(B.last(e.getClientRects())); i&&(this.$popover.hide(), this.lastWordRange=e, this.hints.forEach(function(t, e) {
